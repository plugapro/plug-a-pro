-- Repair marker + enum drift for provider auto-approve replay safety.
-- This migration is intentionally idempotent and can run on environments where
-- previous release deployed schema partially.
