...
-- CreateTable
CREATE TABLE "WhatsappPreferenceLog" (
    "id" TEXT NOT NULL,
    "customerId" TEXT NOT NULL,
    "field" TEXT NOT NULL,
    ...
    CONSTRAINT "WhatsappPreferenceLog_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "WhatsappPreferenceLog_customerId_idx" ON "WhatsappPreferenceLog"("customerId");
...
-- AddForeignKey
ALTER TABLE "WhatsappPreferenceLog" ADD CONSTRAINT "WhatsappPreferenceLog_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "customers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
