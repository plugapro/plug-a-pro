...
export const TEMPLATES = {
  ...
  // ─── Provider onboarding recovery templates (2026-06-06) ───────────────────
  ...
  provider_recovery_evidence: {
    ...
    // {{1}} provider first name, or "there" when unknown
    example:
  ...
  provider_recovery_started_blocked: {
    ...
    language: 'en_ZA',
    category: 'UTILITY',
    description: 'Outside-session recovery for providers blocked after starting registration.',
    // {{1}} provider first name, or "there" when unknown
    example:
  ...
  provider_recovery_no_name: {
    ...
    language: 'en_ZA',
    category: 'UTILITY',
    description: 'Outside-session recovery for providers who tapped register but did not send their name.',
    // {{1}} provider first name, or "there" when unknown
    example:
  ...
  provider_recovery_welcome_idle: {
    ...
    language: 'en_ZA',
    category: 'UTILITY',
    description: 'Outside-session recovery for WhatsApp users idle at the provider welcome step.',
    // {{1}} provider first name, or "there" when unknown
    example:
  ...
  provider_recovery_flow_conflict: {
    ...
    language: 'en_ZA',
    category: 'UTILITY',
    description: 'Outside-session recovery when WhatsApp state suggests provider and customer flow conflict.',
    // {{1}} provider first name, or "there" when unknown
    example:
