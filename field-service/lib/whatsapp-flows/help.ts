...
async function handleHelpMenu(ctx: FlowContext): Promise<FlowResult> {
  await sendList(
    ...
    [{
      ...
      rows: [
        { id: 'faq_cost', title: '💰 How much does it cost?' },
        { id: 'faq_areas', title: '📍 Which areas do you serve?' },
        { id: 'faq_how_long', title: '⏱ How long does a job take?' },
        { id: 'faq_cancel', title: '❌ Can I cancel my booking?' },
        { id: 'faq_reschedule', title: '🔄 Can I change my booking time?' },
        { id: 'faq_payment', title: '💳 How does payment work?' },
        { id: 'faq_technician', title: '👷 Who will come to my home?' },
        { id: 'faq_problem_with_job', title: '🚨 Problem with a job' },
        { id: 'faq_contact_human', title: '📞 Speak to a person' },
      ],
    }],
