  ...
  await sendList(
    ...
    [{
      ...
      rows: [
        ...
        { id: 'faq_technician',      title: '👷🏽 Service providers',   description: 'How profiles and records work' },
