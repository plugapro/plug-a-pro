...
NORMALIZED_INPUT_TO_TAG.set('tiler', 'tiling')
NORMALIZED_INPUT_TO_TAG.set('tilers', 'tiling')
NORMALIZED_INPUT_TO_TAG.set('tile', 'tiling')
NORMALIZED_INPUT_TO_TAG.set('plumber', 'plumbing')
NORMALIZED_INPUT_TO_TAG.set('plumbers', 'plumbing')
NORMALIZED_INPUT_TO_TAG.set('painter', 'painting')
NORMALIZED_INPUT_TO_TAG.set('painters', 'painting')
NORMALIZED_INPUT_TO_TAG.set('carpenter', 'carpentry')
NORMALIZED_INPUT_TO_TAG.set('carpenters', 'carpentry')
NORMALIZED_INPUT_TO_TAG.set('handymen', 'handyman')
NORMALIZED_INPUT_TO_TAG.set('handy man', 'handyman')
NORMALIZED_INPUT_TO_TAG.set('handy men', 'handyman')
