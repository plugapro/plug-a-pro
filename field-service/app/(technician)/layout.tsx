    ...
    <div className="app-shell flex min-h-screen flex-col">
      ...
      <nav className="app-bottom-nav fixed bottom-0 left-0 right-0 z-50 safe-bottom">
        <div className="mx-auto flex h-16 max-w-lg items-center justify-around px-3">
          <AppNavLink href="/technician" label="Jobs" icon="jobs" />
          <AppNavLink href="/technician/earnings" label="Earnings" icon="earnings" />
          <AppNavLink href="/technician/profile" label="Profile" icon="userRound" />
        </div>
      </nav>
    </div>
  )
