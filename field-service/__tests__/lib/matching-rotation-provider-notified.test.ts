...
// Interactive extras are gated on the 24h session window (Task 3 hardening);
// keep this suite's original intent (warm provider, full send path) by
// resolving the window check as open.
