    ...
    <div className="mx-auto max-w-md px-5 py-6">
      ...
      <div className="mt-4 h-56 rounded-3xl border border-border bg-card p-3">
        <div className="relative h-full w-full rounded-2xl bg-[linear-gradient(180deg,#edf3ff,#dbe8ff)]">
          <div className="absolute left-4 top-4 rounded-full bg-white/85 px-3 py-1 text-xs font-mono shadow">ETA {status.etaMins ?? '--'} min</div>
          <div className="absolute left-1/2 top-1/2 h-4 w-4 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[var(--brand-pink)] shadow-[0_0_0_12px_rgba(255,31,142,.2)]" />
        </div>
      </div>
      ...
      {activeExtra ? (
        <div className="fixed inset-x-0 bottom-0 z-40 rounded-t-3xl border-t border-border bg-card px-5 pb-[calc(16px+env(safe-area-inset-bottom,0px))] pt-4">
