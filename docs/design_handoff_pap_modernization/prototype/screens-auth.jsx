  ...
  return (
    <AuthShell T={T} onBack={() => go('signin')}
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        {T.showWA && (
          <Card T={T} padded={false} style={{ padding: '14px 14px', background: 'rgba(37,211,102,0.06)', boxShadow: `inset 0 0 0 1px rgba(37,211,102,0.18)` }}>
            <div style={{ display: 'flex', gap: 12 }}>
              <div style={{
                width: 36, height: 36, borderRadius: 10, background: T.whatsapp,
            ...
            <button style={{
              ...
              border: 'none', background: T.whatsapp, color: '#fff',
              fontFamily: T.fam, fontWeight: 600, fontSize: 13.5,
              display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
              cursor: 'pointer',
            }}>
              <IcWhats size={15} /> Open WhatsApp · Send "Register"
            </button>
          </Card>
        )}
        <div style={{
