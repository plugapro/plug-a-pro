...
| 8 | `08-client-request-data-capture-and-privacy.md` | `docs/codex-execution/008-client-request-data-capture-and-privacy-output.md` | Completed | Added WhatsApp urgency/provider preference/budget capture, request metadata persistence, request ref generation, privacy copy, and tests; PWA capture and `accessNotes` / safe-preview parity now implemented end-to-end. |
...
| 12 | `12-customer-shortlist-and-selection.md` | `docs/codex-execution/012-customer-shortlist-and-selection-output.md` | Completed | Added customer shortlist generation, secure ticket shortlist cards, provider selection, selected-provider notification, request statuses, migration, and tests; shortlist-ready customer CTA plus ask-more/cancel shortlist actions are in place. |
...
| 14 | `14-whatsapp-template-and-url-audit.md` | `docs/codex-execution/014-whatsapp-template-and-url-audit-output.md` | Completed | Updated public URL validation and provider credit copy for shortlist credit timing; WhatsApp opportunity button wiring and shortlist-ready outbound notification are now completed. |
...
- Confirm that customer-visible shortlist messaging remains aligned to the active shortlist state transitions across the pilot rollout.
