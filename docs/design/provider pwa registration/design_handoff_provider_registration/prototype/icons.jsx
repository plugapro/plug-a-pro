...
const IcLeaf    = (p) => <Icon {...p}><path d="M3 17c0-7 6-13 14-13 0 8-6 14-13 14-.3 0-.7 0-1-.1z"/><path d="M3 17l8-8"/></Icon>;
const IcDrill   = (p) => <Icon {...p}><path d="M3 7h7v6H3a1 1 0 01-1-1V8a1 1 0 011-1z"/><path d="M10 9h4l3-2v6l-3-2h-4M5 13v3a1 1 0 001 1h2a1 1 0 001-1v-3"/></Icon>;
const IcTile    = (p) => <Icon {...p}><rect x="2.5" y="2.5" width="6.5" height="6.5" rx="1"/><rect x="11" y="2.5" width="6.5" height="6.5" rx="1"/><rect x="2.5" y="11" width="6.5" height="6.5" rx="1"/><rect x="11" y="11" width="6.5" height="6.5" rx="1"/></Icon>;
const IcTrowel  = (p) => <Icon {...p}><path d="M3 17l5-5M8 12L17 3M14 6l-3-3"/><path d="M4 13l7 1-1-7"/></Icon>;
...
Object.assign(window, {
  ...
  IcMore, IcGrid, IcRefresh, IcLeaf, IcDrill, IcTile, IcTrowel,
});
