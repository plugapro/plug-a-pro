...
>
> Reply with DEMO, TEMPLATES, or PRICING and we'll pick it up first thing.
...
## Links
- Direct: `https://wa.me/27693552447`
- DEMO prefill: `https://wa.me/27693552447?text=DEMO`
- TEMPLATES prefill: `https://wa.me/27693552447?text=TEMPLATES`

## Setup Checklist
- [ ] Apply for WhatsApp Business API via Meta Business Suite
- [ ] Set up wa.me short link
- [ ] Generate QR code for materials
- [ ] Test greeting + away messages
