...
## Single-file Codex execution

Use `00-CODEX-MASTER-RUNNER.md` if you want Codex to execute the full pack in sequence and write a physical Markdown output report after each task.
