    ...
    <div className="py-24 max-w-3xl mx-auto px-4">
      ...
      <div className="prose prose-zinc dark:prose-invert max-w-none">
        ...
        <ul>
          ...
          <li><strong>Verification data:</strong> identity verification status, vendor session references, verification results, expiry dates, and admin review outcomes where identity verification is enabled.</li>
        ...
        <ul>
          ...
          <li><strong>Google services:</strong> Google Analytics on the marketing site and Google Maps or geocoding services where location features are used.</li>
        ...
        <p>
          Some service providers may process information outside South Africa. Where cross-border
          processing applies, we rely on contractual, legal, or other safeguards required by POPIA.
        </p>
