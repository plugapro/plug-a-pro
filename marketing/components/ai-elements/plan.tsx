...
export const PlanTrigger = ({ className, ...props }: PlanTriggerProps) => (
  <CollapsibleTrigger className={cn(buttonVariants({ variant: "ghost", size: "icon" }), "size-8", className)} data-slot="plan-trigger" {...props}><ChevronsUpDownIcon className="size-4" /><span className="sr-only">Toggle plan</span></CollapsibleTrigger>
);
